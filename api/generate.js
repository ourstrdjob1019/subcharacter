...
[작성 방식]
'3년 뒤의 하루 브이로그' 느낌으로 몰입감 있게 작성하되, 핵심만 담아 **3~4문단 내외로 빠르고 간결하게** 요약해 주세요. 절대 길어지지 않게 주의하세요.

[출력 형식]
위 내용을 바탕으로 반드시 아래 JSON 형식으로만 반환해주세요.
{
  "personaTitle": "3년 뒤 나의 모습 (예: 데이터로 세상을 엮어내는 기획자)",
  "description": "핵심만 담은 3~4문단의 3년 뒤 브이로그 형태 텍스트 (줄바꿈은 \\n 처리)",
  "stats": {
    "planning": 85,
    "creativity": 90,
    "relationship": 75,
